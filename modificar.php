      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
              <div class="col-md-12">
                  <div class="box">
                    <h1 class="box-title">Modificar Alumno </h1><br>
                    ...
                    <div class="panel-body table-responsive" style="height: 400px;" id="listadoregistros">
                      <form action="" method="POST">
                        ...
                        <th><input type="number" placeholder="Cedula"></th>
                        </thead>
                          <thead>
                            <th>Modificar</th>
                            <th>Agregar</th>
                          ...
                          <th><input type="checkbox" name="" id=""></th>
                            <th><label for="">Nota del primer lapso</label></th>

                            <th><input type="number" placeholder="Nota"></th>
                          </tbody>
                          <tbody>
                          
                          <th><input type="checkbox" name="" id=""></th>
                            <th><label for="">Nota del Segundo lapso</label></th>
                          ...
                          <th><input type="checkbox" name="" id=""></th>
                            <th><label for="">Nota del Tercer lapso</label></th>
                        ...
                        <a href="../../modificar.php" style="float: right" class="btn btn-primary" ><i class="fa fa-plus-circle"></i> Modificar</a>
